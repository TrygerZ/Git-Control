...
const en = {
  ...
  pending: {
    ...
    stashOpenCommitAria: 'Open commit in graph',
    stashOpenCommitTitle: 'Open commit in graph',
  ...
  format: {
    ...
    actionConsequences: {
      ...
      pull: 'Fetch latest changes and integrate into current branch without rebasing.',
  ...
  commitForm: {
    ...
    pullTitle: (remote: string, branch: string) => `Pull branch ${branch} from ${remote}.`,
    ...
    pullDisabledBusy: 'Operation in progress.',
    pullDisabledNoBranch: 'Cannot pull from detached HEAD.',
