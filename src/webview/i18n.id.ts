...
const id: Catalog = {
  ...
  pending: {
    ...
    stashesHeader: 'Stash',
    stashesEmptyTitle: 'Tidak ada stash.',
    stashesEmptyHint: 'Tumpukan stash kosong.',
    stashApplyLabel: 'Terapkan',
    stashApplyAria: (ref: string) => `Terapkan stash ${ref}`,
    stashApplyTitle: 'Terapkan perubahan dan simpan entri stash.',
    ...
    stashOpenCommitAria: 'Buka commit di graph',
    stashOpenCommitTitle: 'Buka commit di graph',
  ...
  format: {
    ...
    actionConsequences: {
      ...
      stashApply: (index: number) => `Menerapkan perubahan dari stash@{${index}}. Catatan stash tetap tersimpan di tumpukan stash.`,
    ...
    actionTitles: {
      ...
      stashPop: 'Stash pop',
      stashApply: (index: number) => `Terapkan stash@{${index}}`,
  ...
  commitForm: {
    ...
    pullButton: 'Pull',
    pullWithCountButton: (count: string) => `Pull (${count})`,
    ...
    pullTitle: (remote: string, branch: string) => `Tarik branch ${branch} dari ${remote}.`,
    ...
    pullDisabledBusy: 'Operasi sedang berjalan.',
    pullDisabledNoBranch: 'Tidak bisa pull saat HEAD detached.',
